const projectsData = [
    ...
    /*"Desarrollo de un pipeline de análisis de datos para optimizar la proyección del Unit Cash Cost (Costo Unitario en Efectivo). Procesé grandes volúmenes de datos históricos de operación de equipos pesados, desarrollando scripts en Python para ajustar automáticamente distribuciones de probabilidad a las variables operativas.<br><br>Los parámetros estadísticos obtenidos se integraron en modelos financieros en Excel, permitiendo ejecutar simulaciones de Monte Carlo. Esto transformó proyecciones estáticas en herramientas dinámicas de análisis de riesgo, brindando a la gerencia un soporte cuantitativo robusto para la toma de decisiones bajo incertidumbre."*/
    {
        ...
        es: {
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 30px; margin: 40px 0; align-items: start;">
...
with pd.ExcelWriter(output_path) as writer:
    for sheet_name, data_frame in filtered_data.items():
        data_frame.to_excel(writer, index=False, sheet_name=sheet_name)</code></pre>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 30px; margin-top: 40px; align-items: start;">
            ...
            plt.show()</code></pre>
                ...
                <div>
                    ...
                    <div style="background: #111; border: 1px solid #333; border-radius: 12px; display: flex; align-items: center; justify-content: center; padding: 15px; height: calc(100% - 90px);">
                        <img src="assets/images/tornado.jpg" alt="Gráfico de Tornado de Sensibilidades" style="width: 100%; max-height: 450px; object-fit: contain; border-radius: 8px;">
                    </div>
                    <div style="margin-top: 10px; font-size: 0.8rem; color: var(--text-main); opacity: 0.7; font-style: italic; text-align: center;">
        ...
        for nombre, dist en distribuciones.items():
            ...
            plt.show()</code></pre>
                ...
                <div>
                    ...
                    <div style="background: #111; border: 1px solid #333; border-radius: 12px; display: flex; align-items: center; justify-content: center; padding: 15px; height: calc(100% - 90px);">
                        <img src="assets/images/tornado.jpg" alt="Sensitivity Tornado Chart" style="width: 100%; max-height: 450px; object-fit: contain; border-radius: 8px;">
                    </div>
                    <div style="margin-top: 10px; font-size: 0.8rem; color: var(--text-main); opacity: 0.7; font-style: italic; text-align: center;">
...
ORDER BY 
    Dias_Transcurridos DESC;</code></pre>
                ...
                <div>
                    ...
                    <div style="background: #111; border: 1px solid #333; border-radius: 12px; display: flex; align-items: center; justify-content: center; padding: 15px; height: calc(100% - 90px);">
                        <img src="assets/images/Dashboard.jpg" alt="Dashboard de Seguimiento de Especificaciones Técnicas" style="width: 100%; max-height: 450px; object-fit: contain; border-radius: 8px;">
                    </div>
                    <div style="margin-top: 10px; font-size: 0.8rem; color: var(--text-main); opacity: 0.7; font-style: italic; text-align: center;">
...
ORDER BY 
    Days_Elapsed DESC;</code></pre>
                ...
                <div>
                    ...
                    <div style="background: #111; border: 1px solid #333; border-radius: 12px; display: flex; align-items: center; justify-content: center; padding: 15px; height: calc(100% - 90px);">
                        <img src="assets/images/Dashboard.jpg" alt="Technical Specification Tracking Dashboard" style="width: 100%; max-height: 450px; object-fit: contain; border-radius: 8px;">
                    </div>
                    <div style="margin-top: 10px; font-size: 0.8rem; color: var(--text-main); opacity: 0.7; font-style: italic; text-align: center;">
...
const writingData = [
    { 
        ...
        gradient: "url('assets/images/IOS-PC.PNG')" 
    }
];
...
const translations = {
    es: {
        ...
        about_title: "Sobre Mí", about_p1: "Soy un Ingeniero de Sistemas de 26 años radicado en Riohacha, La Guajira. Me especializo en encontrar patrones ocultos en los datos y construir soluciones que automaticen y optimicen los flujos de trabajo corporativos.", about_p2: "Fuera del análisis de datos y la programación en Python, me apasiona el mundo del motociclismo (especialmente recorrer rutas en mi Yamaha) y desconectar disfrutando de la cultura geek y el anime de comedia romántica. Creo firmemente que la creatividad fuera de la pantalla mejora la lógica dentro de ella.",
        ...
        page_home: "Inicio", page_about: "Sobre mí", page_projects: "Mis Proyectos", page_writing: "Mis Artículos", page_stack: "Herramientas", page_services: "Mis Servicios", page_contact: "Contacto",
    ...
    en: {
        ...
        about_title: "About Me", about_p1: "I'm a 26-year-old Systems Engineer based in Riohacha, La Guajira. I specialize in finding hidden patterns in data and building solutions that automate and optimize corporate workflows.", about_p2: "Outside of data analysis and Python programming, I'm passionate about the motorcycling world (especially riding my Yamaha) and unwinding by enjoying geek culture and romantic comedy anime. I firmly believe that creativity off-screen improves logic on-screen.",
        ...
        stack_title: "My Tech Stack", stack_desc: "Tools and languages I use daily to build solutions.", stack_cat1: "Analysis & Backend", stack_cat2: "Visualization & Data", stack_cat3: "Cloud & Infrastructure",
        ...
        page_home: "Home", page_about: "About Me", page_projects: "My Work", page_writing: "My Writing", page_stack: "Tech Stack", page_services: "My Services", page_contact: "Contact",
...
function renderDetail(dataArray, currentId, areaId) {
    ...
    area.innerHTML = `
        ...
        <footer class="site-footer" style="margin-top: auto; padding-top: 40px; border-top: 1px solid var(--border-color);">
            <p>© 2026 RiverAxe by <a href="https://github.com/Aldamen" target="_blank">@aldamen</a></p>
        </footer>
    `;
...
function updateTexts() {
    ...
    logos.forEach(logo => {
        ...
        logo.src = isLight ? 'assets/images/LOGO_PROFESIONAL.png' : 'assets/images/LOGO_PROFESIONAL_Blanco.png';
    });
    // ===============================================
